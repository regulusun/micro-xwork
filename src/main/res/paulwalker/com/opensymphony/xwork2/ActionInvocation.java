...
/**
 * An {@link ActionInvocation} represents the execution state of an {@link com.opensymphony.xwork3.Action}. It holds the Interceptors and the Action instance.
 * By repeated re-entrant execution of the <code>invoke()</code> method, initially by the {@link com.opensymphony.xwork3.ActionProxy}, then by the Interceptors, the
 * Interceptors are all executed, and then the {@link com.opensymphony.xwork3.Action} and the {@link Result}.
 *
 * @author Jason Carreira
 * @see com.opensymphony.xwork3.ActionProxy
 */
