...
import com.opensymphony.xwork3.config.impl.DefaultConfiguration;
...
public class ConfigurationManager {
     ...
     *
     * @see com.opensymphony.xwork3.config.impl.DefaultConfiguration
     */
     ...
     * @see com.opensymphony.xwork3.config.ConfigurationProvider
     */
    public List<ContainerProvider> getContainerProviders() {
        ...
        try {
            if (containerProviders.size() == 0) {
                ...
                containerProviders.add(new XmlConfigurationProvider("src/main/resources/xwork.xml", false));
            }
     ...
     *
     * @param containerProviders list of {@link com.opensymphony.xwork3.config.ConfigurationProvider} to be set
     */
