...
import com.opensymphony.xwork3.util.AnnotationUtils;
...
public class AnnotationWorkflowInterceptor extends AbstractInterceptor implements PreResultListener {
     ...
     *
     * @see com.opensymphony.xwork3.interceptor.Interceptor#intercept(com.opensymphony.xwork3.ActionInvocation)
     */
     ...
     *
     * @see com.opensymphony.xwork2.interceptor.PreResultListener#beforeResult(com.opensymphony.xwork3.ActionInvocation,String)
     */
