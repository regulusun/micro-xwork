 ...
 * using the given implementation of {@link com.opensymphony.xwork3.util.PatternMatcher} by default it
 * uses {@link com.opensymphony.xwork3.util.WildcardHelper}
 *
	...
	private Vector<String> checkEntries(String[] entries, File parent, String prefix) {
		...
		for (String listEntry : entries) {
			...
			if (tempFile.isDirectory() && 
					!(".".equals(listEntry) || "src/test".equals(listEntry)) ) {
				if	(!"".equals(prefix) ) {
