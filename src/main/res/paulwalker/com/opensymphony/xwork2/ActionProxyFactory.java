...
import com.opensymphony.xwork3.ActionProxy;

import java.util.Map;


/**
 * The {@link ActionProxyFactory} is used to create {@link com.opensymphony.xwork3.ActionProxy}s to be executed.
 * <p/>
 * It is the entry point to XWork that is used by a dispatcher to create an {@link com.opensymphony.xwork3.ActionProxy} to execute
 * for a particular namespace and action name.
 *
 * @author Jason Carreira
 * @see com.opensymphony.xwork3.DefaultActionProxyFactory
 */
public interface ActionProxyFactory {

    /**
     * Creates an {@link com.opensymphony.xwork3.ActionProxy} for the given namespace and action name by looking up the configuration.The ActionProxy
     * should be fully initialized when it is returned, including having an {@link com.opensymphony.xwork3.ActionInvocation} instance associated.
     * <p/>
    ...
    public ActionProxy createActionProxy(String namespace, String actionName, String methodName, Map<String, Object> extraContext, boolean executeResult, boolean cleanupContext);
     ...
     /**
     * Creates an {@link ActionProxy} for the given namespace and action name by looking up the configuration.The ActionProxy
     * should be fully initialized when it is returned, including passed {@link com.opensymphony.xwork3.ActionInvocation} instance.
     *
