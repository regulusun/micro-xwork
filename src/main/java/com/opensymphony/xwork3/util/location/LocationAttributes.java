 ...
 */
package com.opensymphony.xwork3.util.location;
...
public class LocationAttributes {
     ...
     * into an object built from this element, consider using {@link #getLocation(org.xml.sax.Attributes, String)}
     ...
     * {@link #getLocation(org.w3c.dom.Element)} and the {@link Locatable} interface.
     * 
     * @param elem the element that holds the location information
     * @return a location string as defined by {@link Location}.
     */
