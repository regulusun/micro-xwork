 ...
 */
package com.opensymphony.xwork3.interceptor;

import com.opensymphony.xwork3.ActionInvocation;
 ...
 * Interceptors may choose to either short-circuit the {@link com.opensymphony.xwork3.ActionInvocation} execution and return a return code
 * (such as {@link com.opensymphony.xwork3.Action#SUCCESS}), or it may choose to do some processing before
 * and/or after delegating the rest of the procesing using {@link com.opensymphony.xwork3.ActionInvocation#invoke()}.
 * <p/>
...
public interface Interceptor extends Serializable {
     ...
     * {@link #intercept(com.opensymphony.xwork3.ActionInvocation) intercept} , giving
     ...
     * request by the {@link com.opensymphony.xwork3.ActionInvocation} or to short-circuit the processing and just return a String return code.
     *
     * @param invocation the action invocation
     * @return the return code, either returned from {@link com.opensymphony.xwork3.ActionInvocation#invoke()}, or from the interceptor itself.
     * @throws Exception any system-level error, as defined in {@link com.opensymphony.xwork3.Action#execute()}.
     */
