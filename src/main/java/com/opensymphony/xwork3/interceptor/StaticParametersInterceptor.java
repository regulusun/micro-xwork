...
import com.opensymphony.xwork3.config.entities.Parameterizable;
import com.opensymphony.xwork3.util.reflection.OgnlUtil;
 ...
 * implements {@link com.opensymphony.xwork3.config.entities.Parameterizable}, a map of the static parameters will be also be passed directly to the action.
    ...
    public String intercept(ActionInvocation invocation) throws Exception {
        ...
        if (parameters != null) {
            ...
            try {
                ...
                ognlUtil.setProperties(parameters, action);
