...
import com.opensymphony.xwork3.util.profiling.UtilTimerStack;
...
//    protected String resultCode;
    ...
    /**
     * @throws com.opensymphony.xwork3.config.ConfigurationException If no result can be found with the returned code
     */
...
//            return resultCode;
    ...
    protected void createAction(Map<String, Object> contextMap) {
        ...
        try {
            ...
            throw new RuntimeException("Unable to intantiate Action!", e);
        } catch (IllegalAccessException e) {
            throw new RuntimeException("Illegal access to constructor, is it public?", e);
        } catch (Exception e) {
            String gripe;
            ...
            throw new RuntimeException(gripe, e);
        } finally {
...
//        contextMap.put(ActionContext.CONTAINER, container);
     ...
     *
     * @throws com.opensymphony.xwork3.config.ConfigurationException If not result can be found with the returned code
     */
...
//            return saveResult(actionConfig, methodResult);
     ...
     *
     * @return instance without reference to
     */
