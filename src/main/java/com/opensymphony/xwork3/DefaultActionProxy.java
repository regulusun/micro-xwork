...
//    protected ActionEventListener actionEventListener;
     ...
     */
    protected DefaultActionProxy(ActionInvocation inv, String namespace, String actionName, String methodName, boolean cleanupContext) {
...
//        this.executeResult = executeResult;
    ...
    protected void prepare() {
        ...
        try {
            UtilTimerStack.push(profileKey);
            //TODO GET ACTION CONFIG
            config = configuration.getPackageConfig(namespace).getActionConfigs().get(actionName);
