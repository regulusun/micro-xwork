 ...
 */
package com.opensymphony.xwork3.config.entities;
 ...
 */
public class PackageConfig implements Comparable, Serializable, InterceptorLocator {
...
//    protected Map<String, Map<String, ActionConfig>> actionConfigs2;
