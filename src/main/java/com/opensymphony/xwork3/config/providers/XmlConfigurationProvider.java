...
//                .location(location)
    ...
    protected boolean verifyAction(String className, String name) {
        ...
        try {
            ...
            throw new ConfigurationException("Action class [" + className + "] does not have a public no-arg constructor", e);
...
//        Location loc = LocationUtils.getLocation(interceptorRefElement);
        return InterceptorBuilder.constructInterceptorReference(context, refName, refParams, objectFactory);
    }
